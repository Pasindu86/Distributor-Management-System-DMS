...
export default function PurchaseHistory() {
  ...
  async function toggleExpand(shipmentId: number) {
    ...
    const { data } = await supabase
      ...
      .select("id, item_id, quantity_added, inventory(item_name, item_type, weight_grams, purchase_price, units_per_pack)")
            ...
            >
              ...
              <div className="shrink-0 text-right">
                <p className="font-mono text-sm font-semibold text-[var(--dms-primary)]">
                  Rs. {toNum(s.total_value).toFixed(2)}
                </p>
              </div>
                ...
                {loadingItems ? (
                  ...
                  <div className="space-y-3">
                    {expandedItems.map((si) => {
                      ...
                      const buyingValue = si.quantity_added * toNum(si.inventory.purchase_price);
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mt-2.5 grid grid-cols-2 gap-3 sm:grid-cols-4">
                            ...
                            <DetailCell label="Buying Value" value={`Rs. ${buyingValue.toFixed(2)}`} highlight />
                          </div>
                        </div>
                      );
                    })}
